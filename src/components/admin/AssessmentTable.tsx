...
function AssessmentTable({ quizArr }: { quizArr: any }) {
                    ...
                    <div className="flex md:flex-row items-center justify-between space-y-0 md:space-y-0 md:space-x-4 p-4">
                        ...
                        <div className="w-fit md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3  flex-shrink-0">
                            <button
                                disabled={true}
                                type="button"
                                className="flex opacity-20 cursor-not-allowed items-center justify-center bg-[#11393C] text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded  px-4 py-2 bg-primary-600 hover:bg-primary-700 ml-3 focus:outline-none focus:ring-primary-800"
                        ...
                        <table className="w-full text-left text-gray-500">
                            <thead className="text-xs  text-gray-400 bg-gray-700/10">
                                <tr>
                                    ...
                                    <th scope="col" className="px-4 py-3">
                                        <span className="">No. of Questions</span>
                                    </th>
                                    <th scope="col" className="px-4 py-3">
                            ...
                            <tbody>
                                {quizArr?.data.map((quiz: any) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-1 font-medium whitespace-nowrap text-black">
                                            <p>{quiz.title}</p>
                                        </td>
                                        ...
                                        <td className="px-4 py-3 flex gap-2">
                                            {/* <button className="flex items-center gap-2 px-3 py-2 bg-[#404eed] rounded text-white">
                                                <span>Edit</span>
                                            </button> */}
