...
function Newsletter({ content }: any) {
    ...
    return (
        <div>
            <ToastContainer />
            <div className='md:min-h-[400px] md:h-fit h-fit lg:top-10 md:left-[10%] lg:absolute md:w-[80%] w-[100%] p-4 flex justify-center items-center text-white bg-[#F08354] lg:bg-white lg:text-[#11393C] py-6 mx-auto md:rounded-xl z-10 rounded-none -translate-y-20  mt-20'>
                <div className='grid xl:grid-cols-3 grid-cols-1 w-[90%] -translate-y-10 xl:-translate-y-0'>
                    ...
                    <div className='self-center flex justify-center xl:order-2 order-1'>
                        <Image src={pointerPNG} alt="" className='scale-50 xl:scale-100' />
                    </div>
                </div>
            </div>

            <div className='lg:h-[400px] h-fit top-10 lg:left-[10%] lg:top-[20%] absolute translate-x-10 -translate-y-0 rounded-xl lg:w-[80%] w-[100%] lg:bg-[#F08354]  bg-white'></div>
