...
function GithubButton() {
    return (
        <div className="w-full py-2 border border-gray-200 rounded flex items-center justify-center cursor-pointer hover:bg-gray-100/10">
            <div className="flex items-center gap-2">
                ...
                <p className="text-black" onClick={() => signIn("github", { callbackUrl: 'http://localhost:3000/' })}>Continue with Github</p>
            </div>
        </div >
    )
}
