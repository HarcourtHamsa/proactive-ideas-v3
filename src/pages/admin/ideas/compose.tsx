...
import { createIdeaPost, createIdeaPostDraft, seperateBlogDataIntoComponents } from "../../../helper";
...
function Compose() {
    ...
    const showPreview = () => {
        // var [title, _] = seperateBlogDataIntoComponents(blogContent);
                        ...
                        <div className="h-fit w-screen bg-transparent fixed top-0 z-[100] flex md:-translate-x-0 justify-end transition duration-75">
                            <div className="w-[90%] h-screen sm:w-[450px]  z-[100] bg-[#fff] shadow-md p-4 transition duration-75 overflow-x-hidden">
                                ...
                                <button
                                    ...
                                    onClick={publishIdea}
                                >
                                    {isLoading && <Spinner />} Publish Content
                                </button>
                                <button
