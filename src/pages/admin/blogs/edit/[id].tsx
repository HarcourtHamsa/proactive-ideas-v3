...
import { createBlogPost, seperateBlogDataIntoComponents, updateBlogPost, updateBlogPostDraft } from "../../../../helper";
...
function EditBlog() {
  ...
  const publishBlog = async () => {
    var [title, _] = seperateBlogDataIntoComponents(blogContent as string);
    setIsLoading(true);
    const tags: string[] = [];
  ...
  return (
    <div>
      <div className='flex justify-between mb-4 items-center px-4 pt-4 bg-white z-50'>
        ...
        <div className="space-x-2">
          ...
          <button className='px-4 py-1 border rounded' onClick={updateFnc}>
            Update
          </button>
        </div>
      </div>
      ...
      {isOpen && (
        <ReactPortal>
          <div className="h-screen w-screen bg-black opacity-60 fixed z-[800] top-0 flex justify-center items-center transition duration-75"></div>
          <div className="h-fit w-screen bg-transparent fixed top-0 z-[900] flex md:-translate-x-0 justify-end transition duration-75">
            <div className="w-[90%] h-screen sm:w-[450px]  z-[1000] bg-[#fff] shadow-md p-4 transition duration-75 overflow-x-hidden">
              <div
              ...
              <form className="my-8 space-y-8 text-black">
                ...
                <div className="mt-10 pr-2">
                  ...
                  <textarea id="message" rows={4} className="block p-2.5 w-full text-black bg-gray-100/50 rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Write description..."
                    name="description"
                    value={description}
              ...
              <button
                ...
                onClick={publishBlog}
              >
                {isLoading && <Spinner />} Update {role === Role.admin ? 'Draft' : 'Blog'}
              </button>
              <button
